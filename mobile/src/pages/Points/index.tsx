...
import { View, Alert, StyleSheet, Text, SafeAreaView, TouchableOpacity, ScrollView, Image } from 'react-native';
    ...
    useEffect(() => {
      async function loadPosition(){
       const {status} = await Location.requestPermissionsAsync();
        ...
        if(status !== 'granted'){
          Alert.alert('Oooops', 'Precisamos de sua permissao para obter a localização')
          return;
        }
        ...
        <SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                ...
                <View style={styles.mapContainer}>
                   { initialPosition[0] !== 0 && (
                     <MapView initialRegion={{latitude: initialPosition[0], longitude: initialPosition[1], latitudeDelta: 0.014, longitudeDelta: 0.014}} style={styles.map}> {points.map( point => (
