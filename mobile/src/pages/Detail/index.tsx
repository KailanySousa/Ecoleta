...
const Detail = () => {
    ...
    function handleWhatsapp(){
      Linking.openURL(`whatsapp://send?phone=${detail.point.whatsapp}&text=Tenho interesse sobre coleta de resíduo`);
    }
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                ...
                <Image style={styles.pointImage} source={{uri: detail.point.image}}></Image>
                ...
                <View style={styles.address}>
                    ...
                    <Text style={styles.addressContent}>{detail.point.city}, {detail.point.uf}</Text>
                </View>
            </View>
